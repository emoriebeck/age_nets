...
procor_plot_fun <- function(df, inv, rule, set, gamma, type, leg){
  ...
  # ggsave(p, file = sprintf("~/Box/networks/SAPA/02-results/01-plots/06-pro-cors/%s/png/%s-%s-%s-%s.png"
  #                          , type, inv, rule, set, gamma)
  #        , width = 12, height = 12)
  # ggsave(p, file = sprintf("~/Box/networks/SAPA/02-results/01-plots/06-pro-cors/%s/pdf/%s-%s-%s-%s.pdf"
  #                          , type, inv, rule, set, gamma)
         # , width = 12, height = 12)
  p
}
...
combine_plots_fun <- function(all, between, within, inv, rule, set, gamma){
  ...
  ggsave(p, file = sprintf("~/Box/networks/SAPA/02-results/01-plots/06-pro-cors/png/%s-%s-%s-%s.png"
                           , inv, rule, set, gamma)
         , width = 12, height = 8)
  ggsave(p, file = sprintf("~/Box/networks/SAPA/02-results/01-plots/06-pro-cors/pdf/%s-%s-%s-%s.pdf"
                           , inv, rule, set, gamma)
  , width = 12, height = 8)
}
